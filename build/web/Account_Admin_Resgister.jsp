    ...
    <head>
        ...
        <script language="javascript">
            function kiemtra()
            {
                ...
                if (pass_again!=pass)
                {
                    document.getElementById("loi_RePass").innerHTML = "Không trùng mật khẩu";
                    return false;
                } else {
                ...
                tenhienthi=f.tenhienthi.value;
                if(tenhienthi=="")
                {
                    document.getElementById("loi_TenHienThi").innerHTML = "Chưa nhập tên hiển thị";
                    return false;
                } else {
                    document.getElementById("loi_TenHienThi").innerHTML = "";
                }
                sdt=f.sdt.value;
        ...
        <div>
            <div class="header">
                ...
                <div class="content">
                    ...
                    <form name="FDK"action="XuLyThemTKAdmin" method="post">
                            ...
                            <tr>
                                <td>
                                    <input  class="hienthi" type="password" name="nhaplaimatkhau" id="nhaplaimatkhau" placeholder="   Nhập lại password"/>
                                     <br>
                                    <span id="loi_RePass" class="baoloi" style="color: red"></span>
                                    <br /><br />
                                </td>
                            </tr>
                            <tr>
                             ...
                             <tr>
                                <td>
                                    <input  class="hienthi" type="text" name="tenhienthi" id="tenhienthi" placeholder="   Tên hiển thị"/>
                                     <br>
                                    <span id="loi_TenHienThi" class="baoloi" style="color: red"></span>
                                    <br /><br />
                                </td>
                            </tr>
